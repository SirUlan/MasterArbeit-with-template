...
\end{equation}
Given the condition $\beta > n^{-1}$ we can directly determine the minimal energy $E_0$ of a particle for the production of Cherenkov light:
\begin{equation}
    E = \gamma m_{0} c^2 = \dfrac{m_{0} c^2}{\sqrt{1-\beta^2}} > E_0 = \dfrac{m_{0}c^2}{\sqrt{1-n^{-2}}} =  m_{0}c^2\sqrt{\dfrac{n^2}{n^2-1}},
\end{equation}
where $m_0$ is the invariant mass of the particle and $\gamma = \dfrac{1}{\sqrt{1-\beta^2}}$ the Lorentz factor.