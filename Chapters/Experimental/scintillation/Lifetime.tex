\section{Lifetime}
\label{ch:lifetime}
This chapter presents the results of the lifetime measurement of the glass and gel sample scintillation. First, the acquisition and calculation of the time distributions is explained in section \ref{sec:measuringLifeTime}. Further these results are corrected in section \ref{sec:correctionOfLifeTime}, due to limitations of the detection method.
...
\vspace{-10pt}
\end{wrapfigure}
The average lifetimes of the distributions are also shown in table \ref{tab:fitLTglass}. The results for the glass samples are very similar, exhibiting an average time constant of around $\sim \SI{10}{\mu s}$. There seems to be an increase of the lifetime with lower temperatures, although not by much. The gel samples, on the other side, exhibit a much faster emission with an average time constant of approximately $\sim \SI{5}{ns}$ (QSI) and $\sim \SI{35}{ns}$ (Wacker), and a more distinguishable slowing down of the emission at colder environments. 
...
\par By calculating the probability for the detection of a photon of the component $k$ after another one, the reconstructed fractional contribution $\widetilde{f_k}$ can be written as
\begin{equation}
\label{eq:frec}
...
\end{equation}
The first term of the equation \ref{eq:frec} is the probability for both detected photons stemming from the distribution $l$, the second and third term includes the probability of measuring one photon of $k$ or $m$ followed by one of the $l$ component. 
\begin{wrapfigure}{o}{0.5\textwidth}
\centering
...
\begin{table}[H]
\centering
\caption{Corrected fractional contribution of the fit parameters shown in table \ref{tab:fitLTglass} from the measurements with the Vitrovex and Benthos glass samples.}
...
$\overline{\tau}$ & $\SI{8.77\pm0.22}{\mu s}$ & $\SI{8.83\pm0.23}{\mu s}$ & $\SI{9.69\pm0.25}{\mu s}$ & $\SI{9.50\pm0.25}{\mu s}$ & $\SI{11.40\pm0.33}{\mu s}$ \\\toprule
...
$\overline{\tau}$ & $\SI{8.0\pm0.4}{\mu s}$   & $\SI{8.7\pm0.4}{\mu s}$   & $\SI{8.7\pm0.4}{\mu s}$   & $\SI{8.1\pm0.4}{\mu s}$  & $\SI{7.9\pm0.3}{\mu s}$    \\ \bottomrule
\end{tabular}}
\end{table}
\begin{figure}[H]
  \centering
...
Figure \ref{fig:meanAverage} shows the corrected mean lifetime $\overline{\tau}$ of the samples in dependence of the temperature. For all specimens exhibit a faster emission with higher temperatures, except for the Benthos glass. As seen in section \ref{sec:QYLif}, this is expected for a sample where thermal quenching is the most important nonradiative process that is temperature dependent, as the probability of surpassing the energy barrier that connects the excited and ground states is higher (see figure \ref{fig:nonradiative}). This is not the case for the Benthos sample, where accounting the uncertainty the average lifetime remains fairly constant. This could imply that there are other non-negligible processes that are temperature dependent, or that the energy barrier is large, and thus the temperature range used in the experiment is to small for noticing any change. Since the recombination efficiency should show a similar temperature dependence as the lifetime (see equation \ref{eq:recEff}), more information about the involved processes can be further obtained in the next section, where the results for the scintillation yield are presented.

\begin{table}[H]
\centering
\caption{Corrected fractional contribution of the fit parameters shown in table \ref{tab:fitLTglass} from the measurements with the Wacker and QSI gel samples with and without consideration of the transit time spread of the PMT.}
...
$\overline{\tau}$ & $\SI{27.8\pm1.9}{ns}$   & $\SI{30.9\pm1.7}{ns}$   & $\SI{31.8\pm1.7}{ns}$   & $\SI{31.5\pm1.5}{ns}$   & $\SI{32.2\pm1.6}{ns}$   \\\midrule
...
$\overline{\tau}$ & $\SI{26.8\pm1.8}{ns}$   & $\SI{29.8\pm1.6}{ns}$   & $\SI{30.7\pm1.6}{ns}$   & $\SI{30.4\pm1.5}{ns}$   & $\SI{31.1\pm1.6}{ns}$   \\\toprule
QSI gel           &                         &                         &                         &                         &                         \\\midrule
...
$\overline{\tau}$ & $\SI{3.4\pm0.4}{ns}$ & $\SI{4.0\pm0.4}{ns}$ & $\SI{4.6\pm0.5}{ns}$ & $\SI{4.9\pm0.5}{ns}$ & $\SI{5.1\pm0.5}{ns}$ \\\midrule
                  & \multicolumn{4}{l}{Considering TTS}                                                                   &                         \\\midrule
...
$\overline{\tau}$ & $\SI{2.9\pm0.3}{ns}$ & $\SI{3.5\pm0.3}{ns}$ & $\SI{4.0\pm0.3}{ns}$ & $\SI{4.2\pm0.3}{ns}$ & $\SI{4.3\pm0.3}{ns}$ \\ \bottomrule
\end{tabular}}
\end{table}
...
\begin{figure}[H]
  ...
  \end{minipage}
  \caption{Mean lifetime of the corrected emission of the four samples in dependency of the temperature.}
