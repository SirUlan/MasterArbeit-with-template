...
In this section the yield is calculated exciting the samples with the alpha source. For this the activity and an estimation of the isotope distribution on the source surface is needed. Besides it is also necessary to calculate the air scintillation yield, since there is a small gap between the samples and the source.
...
\sub\begin{wrapfigure}{o}{0.5\textwidth}
\centering
...
\subsection{Air scintillation yield}
Reference $\SI{19\pm3}{MeV^{-1}}$  \cite{Sand_2014} , $\SI{18.9\pm2.5}{MeV^{-1}}$ \cite{Thompson_2016}
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.49\textwidth}
