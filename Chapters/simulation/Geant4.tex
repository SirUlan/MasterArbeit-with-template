\chapter[Geant4 simulation for optical modules]{\LARGE{Geant4 simulation for optical modules}}
\label{ch:g4}
...
\caption{\textbf{Top}: One event of a $\ch{^{40}K}$ decay inside the DOM glass. The orange lines represent the trajectories of single photons. The positions of interactions are marked by yellow dots. \textbf{Bottom}: Cumulative output of three events of alpha particles exiting the air, which then scintillates.}
